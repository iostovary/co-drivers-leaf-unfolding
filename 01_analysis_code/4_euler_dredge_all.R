...
source(paste0(location, chapter, "00_helpers/rename_fun.R"))

# load random effects and autoregression parameter
random_simple <- readRDS(paste0(location, chapter, "own_data/output_data/random_simple.rds"))
autoregression_simple <- readRDS(paste0(location, chapter, "own_data/output_data/autoregression_simple.rds"))
...
data <- readRDS(paste0(location, chapter, "own_data/output_data/data_", data_subset , species_ID, "_", phase_ID, ".rds")) %>%
  rename_fun() %>%
...
# load fixed effects
fixed_mainstream <- readRDS(paste0(location, chapter, "own_data/output_data/",
                                   "fixed_mainstream_", species_ID, "_", gsub(" ", "_", phase_ID), ".rds"))
fixed_conservative <- readRDS(paste0(location, chapter, "own_data/output_data/",
                                     "fixed_conservative_", species_ID, "_", gsub(" ", "_", phase_ID), ".rds"))

# load model
model <- readRDS(paste0(location, chapter, "own_data/output_data/",
...
saveRDS(best, paste0(location, chapter, "own_data/output_data/",
...
paste0(location, chapter, "own_data/output_data/",
